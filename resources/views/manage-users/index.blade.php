                    ...
                    <div class="flex items-center justify-between mb-2 mt-2 space-x-2 w-full">
                        ...
                        <form method="GET" action="{{ route('end_users.index') }}"
                            ...
                            <button type="submit"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                    class="size-5">
                                    <path fill-rule="evenodd" d="M9 3.5a5.5 5.5 0 1 0 0 11 5.5
                                          5.5 0 0 0 0-11ZM2 9a7 7 0 1 1 12.452
                                          4.391l3.328 3.329a.75.75 0 1 1-1.06
                                          1.06l-3.329-3.328A7 7 0 0 1 2 9Z" clip-rule="evenodd" />
                                </svg>
                            </button>
                        </form>
                        ...
                        <a href="{{ route('end_users.create') }}" type="button"
                            ...
                            <span class="mr-2">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                    class="size-5">
                                    <path d="M10 5a3 3 0 1 1-6 0 3 3 0 0
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                @foreach ($endUsers as $endUser)
                                    <tr
                                        class="{{ $endUser->excluded ? 'bg-red-200 dark:bg-red-900' : 'bg-white dark:bg-gray-800' }}
                                        ...
                                        <td class="px-2 py-4">
                                            ...
                                            <div id="dropdownMenu{{ $endUser->id }}"
                                                ...
                                                <ul
                                                    ...
                                                    <!-- Edit Action -->
                                                    <li>
                                                        <a href="{{ route('end_users.edit', \Vinkla\Hashids\Facades\Hashids::encode($endUser->id)) }}"
                                                        ...
                                                        <form id="deleteForm{{ $endUser->id }}"
                                                            ...
                                                            <button type="button"
                                                                ...
                                                                <svg class="w-5 h-5 mr-2"
                                                                    ...
                                                                    <path fill-rule="evenodd" d="M5 3.25V4H2.75a.75.75 0 0
                                                                            0 0 1.5h.3l.815
