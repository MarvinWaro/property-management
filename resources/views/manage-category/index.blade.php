<x-app-layout>
                ...
                <div class="section-container p-5">
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            <caption class="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                                ...
                                <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
                                    Below is the list of registered categories.
                                </p>
                            </caption>
                                ...
                                @forelse ($categories as $category)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-2 py-4">
                                            ...
                                            <button id="dropdownActionButton{{ $category->id }}" data-dropdown-toggle="dropdownAction{{ $category->id }}"
                                            ...
                                            <!-- Dropdown Menu -->
                                            <div id="dropdownAction{{ $category->id }}"
                    ...
                    <nav class="flex items-center justify-between pt-4 mb-3" aria-label="Table navigation">
                        <div class="text-sm text-gray-500">
                            {{-- Pagination summary could be added here --}}
                        </div>
                        <div class="mt-2 sm:mt-0">
                            {{-- Insert your pagination links here, e.g., $categories->links() if using pagination --}}
                        </div>
                    </nav>
                </div>
            </div>
    ...
    <script>
        function confirmDelete(categoryId) {
            Swal.fire({
                title: "Are you sure?",
                text: "Do you really want to permanently remove this item? Once deleted, it cannot be recovered.",
                icon: "warning",
