                                                    ...
                                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 request-row"
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                            <div class="flex flex-col">
                                                                <span
                                                                    class="dark:text-gray-300">{{ $request->ris_date->format('M d, Y') }}</span>
                                                                <span
                                                                    class="text-xs text-gray-500 dark:text-gray-400">{{ $request->created_at->format('h:i A') }}</span>
                                                            </div>
                                                        </td>
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                                            ...
                                                            <div id="tooltip-view-request-{{ $loop->index }}"
                                                                role="tooltip"
