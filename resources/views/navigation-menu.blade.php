        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="hidden sm:flex space-x-8 -mb-px">
                @if (auth()->user()->role === 'admin' && !$isAssetsMode)
                    ...
                    class="border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300 whitespace-nowrap py-4 px-1 font-medium text-sm transition-all duration-200
                            {{ request()->routeIs('dashboard') ? 'border-[#ce201f] text-[#ce201f] dark:border-[#ce201f] dark:text-[#ce201f]' : '' }}">
                        Dashboard
                    </a>
