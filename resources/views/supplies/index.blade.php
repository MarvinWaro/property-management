                ...
                <div class="section-container p-7">
                    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                        <div class="mb-4 flex items-center justify-between gap-4 md:mb-8">
                            <h2 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Select by
                                category</h2>
                        </div>
                            ...
                            <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
                                ...
                                <div
                                    ...
                                    <div class="pt-6">
                                        ...
                                        <div class="mt-4 flex items-center justify-between gap-4">
                                            <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">$1,199
                                            </p>
                                ...
                                <div
                                    ...
                                    <div class="pt-6">
                                        ...
                                        <div class="mt-4 flex items-center justify-between gap-4">
                                            <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">$699
                                            </p>
                                ...
                                <div
                                    ...
                                    <div class="pt-6">
                                        ...
                                        <div class="mt-4 flex items-center justify-between gap-4">
                                            <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">$899
                                            </p>
