        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div id="supply-cards-container">
                @foreach($reportData as $supplyData)
                    <!-- Supply Card -->
                    <div class="supply-card bg-white dark:bg-gray-800 overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700 shadow mb-6"
            ...
            <!-- No Results Message -->
            <div id="no-results-message" class="hidden bg-white dark:bg-gray-800 overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700 shadow p-8 text-center">
                ...
                <div class="mt-6">
                    <button id="clear-search-btn" type="button" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
