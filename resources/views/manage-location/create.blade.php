            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="section-container p-5">
                    <div class="max-w-md mx-auto bg-white dark:bg-gray-800 p-6">
                        <!-- Heading -->
                        <h2 class="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Create New Location</h2>
                        <form action="{{ route('location.store') }}" method="POST" onsubmit="showLoader()">
                            ...
                            <div class="mb-4">
                                <div class="relative">
                                    ...
                                    <input type="text" id="location_name" name="location_name" value="{{ old('location_name') }}"
