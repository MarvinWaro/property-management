            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="section-container p-5">
                    <div class="max-w-4xl mx-auto bg-white dark:bg-gray-800 p-6">
                        ...
                        <form action="{{ route('supplier.update', $supplier->id) }}" method="POST" onsubmit="showLoader()">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="flex-1 mb-4">
                                    ...
                                    <div class="mb-4">
                                        <div class="relative">
                                            ...
                                            <input type="text" id="email" name="email" value="{{ old('email', $supplier->email) }}"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5
                                                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
                                ...
                                <div class="flex-1 mb-4">
                                    ...
                                    <div class="mb-4">
                                        <div class="relative">
                                            ...
                                            <input type="text" id="contact_no" name="contact_no" value="{{ old('contact_no', $supplier->contact_number) }}"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5
                                                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
