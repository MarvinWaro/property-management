                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            <caption class="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                                ...
                                <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
                                    Explore the key departments driving higher education excellence in the Philippines.
                                </p>
                            </caption>
                                ...
                                @forelse($departments as $department)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-2 py-4">
                                            ...
                                            <button id="dropdownToggle{{ $department->id }}" data-dropdown-toggle="dropdownMenu{{ $department->id }}"
                                            ...
                                            <!-- Dropdown Menu -->
                                            <div id="dropdownMenu{{ $department->id }}"
