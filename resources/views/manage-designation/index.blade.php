            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="section-container p-5">
                    ...
                    <div class="flex items-center justify-between mb-2 mt-2 space-x-2 w-full">
                            ...
                            <div class="relative flex-grow">
                                <input type="text" name="search" id="search-input"
                                    ...
                                    class="px-4 py-2 w-full border text-sm font-medium border-gray-300 rounded-lg
                                        focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-white
                        ...
                        <a href="{{ route('designations.create') }}" type="button"
                            ...
                            <span class="mr-2">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                    class="size-5">
                                    <path d="M10 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM1.615 16.428a1.224 1.224 0 0 1-.569-1.175
                                            6.002 6.002 0 0 1 11.908 0c.058.467-.172.92-.57 1.174A9.953 9.953 0 0 1 7 18a9.953
                                            9.953 0 0 1-5.385-1.572ZM16.25 5.75a.75.75 0 0 0-1.5 0v2h-2a.75.75 0 0 0 0
                                            1.5h2v2a.75.75 0 0 0 1.5 0v-2h2a.75.75 0 0 0 0-1.5h-2v-2Z" />
                                </svg>
                            </span>
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            <caption
                                ...
                                <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
                                    Manage and explore designations in your organization.
                                </p>
                            </caption>
                            <thead
                                ...
                                @forelse($designations as $designation)
                                    <tr
                                        ...
                                        <td class="px-2 py-4">
                                            ...
                                            <button id="dropdownToggle{{ $designation->id }}"
                                                data-dropdown-toggle="dropdownMenu{{ $designation->id }}"
                                            ...
                                            <!-- Dropdown Menu -->
                                            <div id="dropdownMenu{{ $designation->id }}"
                                                ...
                                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                                                    ...
                                                    <li>
                                                        <form id="deleteForm{{ $designation->id }}" action="{{ route('designations.destroy', $designation->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="button" onclick="confirmDelete('deleteForm{{ $designation->id }}', '{{ $designation->name }}')"
                    ...
                    <nav class="flex items-center justify-between pt-4 mb-3" aria-label="Table navigation">
                        <div class="text-sm text-gray-500">
                            {{-- Optionally, add a pagination summary --}}
                        </div>
