                ...
                <div class="section-container p-5">
                    ...
                    <div class="flex items-center justify-between mb-4 mt-2 space-x-2 w-full">
                        ...
                        <form method="GET" action="{{ route('designations.index') }}"
                            ...
                            <div class="relative flex-grow">
                                <input type="text" name="search" id="search-input"
                                    ...
                                    class="px-4 py-2 w-full border text-sm font-medium border-gray-300 rounded-lg
                                        focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-800 dark:border-gray-700 dark:text-white
                            ...
                            <!-- Search Button -->
                            <button type="submit"
                                class="px-3 py-2 text-sm text-white bg-orange-600 rounded-lg hover:bg-orange-800
                                    focus:ring-1 focus:outline-none focus:ring-orange-300 dark:bg-orange-600 dark:hover:bg-orange-700
                                                ...
                                                <td class="px-2 py-4">
                                                    <div class="flex items-center justify-center space-x-2">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            class="edit-designation-btn p-2 bg-yellow-100 text-yellow-600 rounded-lg hover:bg-yellow-200 focus:outline-none focus:ring-2 focus:ring-yellow-300 dark:bg-yellow-900 dark:text-yellow-300 dark:hover:bg-yellow-800 transition-all duration-200">
