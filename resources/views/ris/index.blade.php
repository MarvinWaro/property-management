            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
                ...
                <div class="p-5 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex flex-wrap items-center justify-between gap-4">
                        ...
                        <!-- Search Form -->
                        <form method="GET" action="{{ route('ris.index') }}" class="w-full max-w-sm flex items-center space-x-2">
                            <div class="relative flex-grow">
                                <input type="text" name="search" id="search-input" value="{{ request()->get('search') }}"
                                       oninput="toggleClearButton()" placeholder="Search RIS number, requestor..."
                ...
                <div class="p-5">
                    <!-- Alert Messages -->
                    @if (session('success'))
                        <div id="alert-success" class="flex items-center p-4 mb-5 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
                    ...
                    <div class="p-4 mb-4 text-sm text-gray-700 rounded-lg bg-gray-50 dark:bg-gray-700 dark:text-gray-300">
                        <h3 class="text-lg font-semibold mb-1 text-gray-900 dark:text-white">Requisition and Issue Slips</h3>
                        <p>
                            This section manages all supply requisitions, allowing you to track requests from departments,
                            approve valid requests, and process the issuance of supplies. Each RIS documents the flow of
                            supplies from storage to end-users.
                        </p>
                    </div>
                                    ...
                                    <tbody>
                                        @forelse ($risSlips as $ris)
                                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                                                ...
                                                <td class="px-6 py-4">
                                                    <a href="{{ route('ris.show', $ris->ris_id) }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xs px-3 py-1.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                                                        View Details
                                                    </a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan="6" class="px-6 py-8 text-center">
                                                    ...
                                                    <div class="flex flex-col items-center justify-center py-8">
                                                        <svg class="w-12 h-12 text-gray-400 mb-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 4v15a1 1 0 0 0 1 1h15M8 16l2.5-5.5 3 3L17.3 7 20 9.7"/>
                                                        </svg>
                                                        <p class="text-lg font-medium text-gray-500 dark:text-gray-400">No requisitions found</p>
                                                        <p class="text-gray-400 dark:text-gray-500 text-sm mt-1">There are no requisition slips in the system yet.</p>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforelse
